...
excluded) for a total of 98 trials.  A single trial comprises 24 hours of
...
experiments represent 98 days of fuzzing to demonstrate fuzzer performance for
...
\bottomrule
\end{tabular} 
        \caption{Main results of controlled experiment. We fuzzed each project for 14 trials (24 hours per trial) in different configurations: \texttt{baseline-AFL}, \texttt{AF++},  \texttt{text-mutation}, and \texttt{splice-mutation}.
