...
The majority of bugs reported in \texttt{Move} compiler were quickly confirmed and fixed, and developers expressed interest in incorporating our approach into their fuzzing CI.\footnote{Public dialog omitted for anonymity.}  % link: https://github.com/diem/diem/issues/7384#issuecomment-769443728
