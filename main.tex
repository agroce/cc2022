...
%% Zig %%
\newcommand{\zigUniqueFixed}{2}
\newcommand{\zigUniqueFixedOrConfirmed}{2}

%% ALL %%
\newcommand{\allValidDuplicates}{15} % \feValidDuplicates (6) + \solAValidDuplicates (9)
\newcommand{\allUniqueFixed}{124} % \solUniqueFixed (68) + \movUniqueFixed (12) + \zigUniqueFixed (2) + \feUniqueFixed (41)
\newcommand{\allUniqueConfirmed}{12} % \solUniqueConfirmed (2) + \movUniqueConfirmed (2) + \zigConfirmed (0) + \feUniqueConfirmed (8)
